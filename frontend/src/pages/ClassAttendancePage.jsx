...
export default function ClassAttendancePage() {
    ...
    const findStudents = () => {
        if (searchInput === "") {
            ...
            return data.studentData.filter(student => {
                return student.ID.toLowerCase().includes(searchInput.toLowerCase()) ||
            ...
            <div id="classAttendancePage">
                ...
                <div id="topRow">
                    <div className="attendanceInfoBox" id="present">
                        <span><img src="/icons8-checked-50.png  "/><p
                            className="spanText">Total Students Present</p></span>
                    ...
                    <div className="attendanceInfoBox" id="absent">
                        <span><img src="/icons8-exclamation-50.png"/><p
                            className="spanText">Total Students Absent</p></span>
                ...
                <div id="attendanceTableContainer">
                    ...
                    <table id="attendanceTable">
                        ...
                        <tr>
                            <th onClick={() => {
                                updateSort("ID")
                            }}>ID {sortField !== "ID" ? "" : sortDirection === -1 ? "▼" : "▲"}</th>
                            <th onClick={() => {
                                updateSort("name")
                            }}>Name {sortField !== "name" ? "" : sortDirection === -1 ? "▼" : "▲"}</th>
                            <th onClick={() => {
                                updateSort("arrivalTime")
                            }}>Arrival Time {sortField !== "arrivalTime" ? "" : sortDirection === -1 ? "▼" : "▲"}</th>
                            <th onClick={() => {
                                updateSort("status")
                            }}>Status {sortField !== "status" ? "" : sortDirection === -1 ? "▼" : "▲"}</th>
                        </tr>
                        </thead>
                        <tbody>
